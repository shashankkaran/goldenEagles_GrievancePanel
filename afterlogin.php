...
<head>
	...
	<script>
		...
		function makecomplaint() {
			...
			if (mcom.style.display == 'block') {} else {
...
<body>
	<nav class="navbar-nav nav2 navbar-expand-sm bg-primary">
		...
		<div class="nav-item item1" style="margin-left:5%">
			<h3 style="color:white"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
	...
	<nav class="navbar navbar1 bg-light" style="float:left;margin-top:0px;display:block;
		...
		<ul class="navbar-nav" style="width:100%;background-color:#17a2b86e;">
			<li class="nav-item">
				<img src="iconmonstr-user-20-96.png" width="90px" height="80px">
			</li>
			<li class="nav-item">
				<a class="btn btn-dark btn1" onclick="dashboard()" href="#">Dashboard</a>
			</li><br />
			<li class="nav-item">
				<a class="btn btn-light btn1" onclick="comp()" href="#"><b>Complaints</b> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
			...
			<li class="nav-item">
				<a class="btn btn-light btn1" onclick="personal()" href="#"><b>Personal Info</b> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
						<path d="M24 12c0-6.627-5.373-12-12-12s-12 5.373-12 12 5.373 12 12 12 12-5.373 12-12zm-17 1h4v-8h2v8h4l-5 6-5-6z" />
					</svg> </a>
			</li>
			<li class="nav-item">
	...
	<div id="main" style="width:78%;float:left;">
		...
		<div class="" id="dashboard" style="width:100%;display:block;padding:20px;">
			...
			<div id="file1" onclick="pending()" style="cursor:pointer;">
				...
				<p id="file12" style="display:block;font-size:15px;text-align:center;">Pending complaints
				<div id="pen"><?php echo $pend; ?></div>
				</p>
			</div>
			<div id="file2" onclick="inpro()" style="cursor:pointer;">
				<i class="fa fa-file-text"></i>
				<p id="file22" style="display:block;font-size:15px;text-align:center;">in progress complaints
				<div id="pen2"><?php echo $inpro; ?></div>
				</p>
			</div>
			<div id="file3" onclick="completed()" style="cursor:pointer;">
				<i class="fa fa-file-text"></i>
				<p id="file32" style="display:block;font-size:15px;text-align:center;">Completed complaints
		...
		<!------------------------------------------------info edit krne k liye ------------------------>
		<!------------------------------compalint marooooooooobeeeeeee -->
		<div class="" id="makecomplaint" style="width:100%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
			...
			<form class="form" action="usermakecomp.php" method="POST" style="width:100%;" enctype="multipart/form-data">
				...
				<!-- kam nahi krrha hai isliy comment out krdiy-->
	...
	<div id="foot" style="background-color:grey;height:80px;width:100%;float:left;margin-top:10px;text-align:center;">
		<!-- © 2021 Grievances Copyright:
		<br>
		<br>
		<br>
    <a href="https://nitjsr.ac.in/">Grievances</a>
		</div> -->
